<form id="form-reserve" action="<?=$this->urlAction;?>" method="post">
  <h3><?=get_option('form-home-title')?></h3>
...
-->
  ...
  <div class="box-button-pagar">
  <input type="submit" value="Reservar" id="reservar" name="reservar">
  </div>
</form>